...
import 'package:portfolio/presentation/widgets/premium_background.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _sendEmail() async {
    final uri = Uri.parse(
      'mailto:tarllyssondesigner@gmail.com'
      '?subject=Contato via Portfolio'
      '&body=Olá Tarllysson, vi seu portfólio e gostaria de conversar.',
    );
    launchUrl(uri);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final navItems = [
      ...
      NavItem(label: 'Contato', onPressed: _sendEmail), // ⭐ abre email direto
    ];
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              OutlinedButton.icon(
                                onPressed: () => _open(
                                    'https://www.linkedin.com/in/tharllyson-silva/'),
                                icon:
                              ...
                              OutlinedButton.icon(
                                onPressed: () =>
                                    _open('https://github.com/TharllysonSilva'),
                                icon: const Icon(Icons.code),
                                label: const Text('GitHub'),
                              ),
                              OutlinedButton.icon(
                                onPressed: () => _open(
                                    'https://www.behance.net/tharllysonsilva'),
                                icon: const Icon(Icons.palette_outlined),
                                label: const Text('Behance'),
                              ),
                            ],
                          ),
                        ],
